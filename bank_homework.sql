...
--SELECT amount FROM payments ORDER BY amount; -- This doesn't work
...
--SELECT * FROM payments WHERE created_at > NOW() - 7; -- This doesn't work

-- In a single query, select all payments with a blank description
SELECT * FROM payments WHERE description is NULL; -- Works
